...
use GlpiPlugin\GlpiAssistia\AssistIA;
...
function plugin_init_glpi_assistia()
{
    ...
    $types = ['Central', 'Computer', 'ComputerDisk', 'Notification', 'Phone', 'Preference', 'Profile', 'Supplier'];
    ...
    Plugin::registerClass(RuleTestCollection::class, ['rulecollections_types' => true]);
    Plugin::registerClass(DeviceCamera::class, ['device_types' => true]);
    ...
    if (AssistIA::canView()) {
        $PLUGIN_HOOKS['menu_toadd']['glpi_assistia'] = [
            'plugins' => AssistIA::class,
            'tools'   => AssistIA::class
        ];
        $PLUGIN_HOOKS[Hooks::HELPDESK_MENU_ENTRY]['glpi_assistia']      = true;
        $PLUGIN_HOOKS[Hooks::HELPDESK_MENU_ENTRY_ICON]['glpi_assistia'] = 'fas fa-robot';
    }
    ...
    $PLUGIN_HOOKS[Hooks::PRE_ITEM_ADD]['glpi_assistia']     = [Computer::class => [AssistIA::class, 'pre_item_add_computer']];
    $PLUGIN_HOOKS[Hooks::POST_PREPAREADD]['glpi_assistia']  = [Computer::class => [AssistIA::class, 'post_prepareadd_computer']];
    $PLUGIN_HOOKS[Hooks::ITEM_ADD]['glpi_assistia']         = [Computer::class => [AssistIA::class, 'item_add_computer']];
    ...
    $PLUGIN_HOOKS[Hooks::PRE_ITEM_PURGE]['glpi_assistia']   = [Computer::class => 'plugin_pre_item_purge_glpi_assistia', 'Phone' => 'plugin_pre_item_purge_glpi_assistia'];
    $PLUGIN_HOOKS[Hooks::ITEM_PURGE]['glpi_assistia']       = [Computer::class => 'plugin_item_purge_glpi_assistia', 'Phone' => 'plugin_item_purge_glpi_assistia'];
    $PLUGIN_HOOKS[Hooks::PRE_ITEM_RESTORE]['glpi_assistia'] = [Computer::class => 'plugin_pre_item_restore_glpi_assistia', 'Phone' => 'plugin_pre_item_restore_glpi_assistia2'];
    $PLUGIN_HOOKS[Hooks::ITEM_RESTORE]['glpi_assistia']     = [Computer::class => 'plugin_item_restore_glpi_assistia'];
    $PLUGIN_HOOKS[Hooks::ITEM_GET_EVENTS]['glpi_assistia']  = ['NotificationTargetTicket' => 'plugin_glpi_assistia_get_events'];
    $PLUGIN_HOOKS[Hooks::ITEM_GET_DATA]['glpi_assistia']    = ['NotificationTargetTicket' => 'plugin_glpi_assistia_get_datas'];
    ...
    $PLUGIN_HOOKS[Hooks::ADD_JAVASCRIPT]['glpi_assistia'] = 'assistia.js';
    $PLUGIN_HOOKS[Hooks::ADD_CSS]['glpi_assistia'] = 'assistia.css';
...
function plugin_glpi_assistia_check_prerequisites()
{
    return true;
}
